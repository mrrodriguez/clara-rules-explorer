...
1a. in the full view sidebar popout for upstream/downstream/input types/insert types/retract types,
...
4. production full view show "dynamic insert callsites" info before "current session activity"
5. Make "curent session activity" collapsible. Use tabs for "active matches" vs "inserted
