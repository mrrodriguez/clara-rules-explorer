1. Convert primary analyze path to use objects from an in-memory clara session.
...
3. Consider an extension to analyze that can take a given callsite and call a helper function to
